...
print(Sys.time())
print(paste0('collecting indices for mag models...'))
indices <- indicesInTargetEqkBins_RDS(sForecastFile, sCatalogFile)
print(Sys.time())
print(paste0('collecting indices for mag models...done'))
resultFile <- paste0(sResultPath, 'indices_mag.rds')
